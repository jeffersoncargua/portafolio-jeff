	...
	return (
		<div className="z-0 md:z-30 relative information md:flex-1 -mt-10 md:mt-0 overflow-hidden w-[90%] p-5 md:p-8 rounded-lg bg-linear-to-t from-green-800/30 to-cyan-400/30 hover:from-green-500/40 hover:to-cyan-600/40 border border-gray-50 inset-shadow-2sm inset-shadow-amber-50 shadow-xl/30 shadow-amber-50 mx-auto md:w-2/3 text-justify text-wrap transition delay-500 duration-300 md:hover:scale-105 text-xs sm:text-sm">
			...
			<p className="tracking-normal align-middle leading-6 md:leading-8">
				...
				mejorar mis habilidades y conocimientos, sobre todo en aprender nuevas
				tecnologías, que me ayuden a mejorar como desarrollador y entregar
				mejores resultados que satisfagan las necesidades de los clientes y de
				los usuarios.
			</p>
		</div>
	);
